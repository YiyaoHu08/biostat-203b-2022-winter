...
### Completeness, correctness and efficiency of solution: 90/100

- Q1 (50/60) Imputation

    I did not catch it earlier, but we never properly fixed your dataset from HW2 which is the same we used in HW3. The reason is your handling of the lab items is wrong and the chart items is wrong. This is paramount. `-10`. Other than inputting the wrong dataset, everything on this HW was great.
